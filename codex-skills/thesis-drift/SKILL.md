...
- `公司名 reports/公司研究/{公司名}/{公司名}-thesis-旧日期.md reports/公司研究/{公司名}/{公司名}-thesis-新日期.md` — 对比两份带日期的论文快照
- `公司名` — 自动查找 `reports/公司研究/{公司名}/{公司名}-thesis.md` 及同目录历史快照；如果没有基线则转入缺失基线处理
...
- 如果只提供公司名 → 查找 `reports/公司研究/{公司名}/{公司名}-thesis.md` 及历史快照，进入**自动快照对比**模式
...
在 `reports/公司研究/{公司名}/` 中查找：
- `reports/公司研究/{公司名}/{公司名}-thesis.md`
- `reports/公司研究/{公司名}/{公司名}-thesis-*.md`
...
4. 如果当前报告已足够完整，可建议将它保存为 `reports/公司研究/{公司名}/{公司名}-thesis.md` 作为未来漂移检测基线
